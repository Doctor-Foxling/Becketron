...
namespace Becketron {
	...
	ExampleLayer1::ExampleLayer1()
		: Layer("ExampleLayer1"), m_CameraController(1280.0f / 720.0f)
	{
	}

	void ExampleLayer1::OnAttach()
	{
		//Renderer3D::Init();
		BT_PROFILE_FUNCTION();
	...
	void ExampleLayer1::OnDetach()
	{
		BT_PROFILE_FUNCTION();
	}

	void ExampleLayer1::OnUpdate(Timestep ts)
	{
		BT_PROFILE_FUNCTION();
	...
	void ExampleLayer1::OnImGuiRender()
	{
	...
	void ExampleLayer1::OnEvent(Event& e)
	{
